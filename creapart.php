...
$cmin = $_POST["cmin"];
       ...
       $consulta="INSERT INTO partidas (nom, contrasenya, jugadores, marcatemp, ordinadors, ordi0, ordi1, ordi2, ordi3, ordi4, ordi5, ordinaconnectat, ni1, ni2, ni3, ni4, ni5, ni6, turno, asignatura, chor, cmin) VALUES ('".$nom."', '".$contrasenya."', '".$jugadores."', '".$marcatemp."', '".$ordinadors."', '".$ordi0."', '".$ordi1."', '".$ordi2."', '".$ordi3."', '".$ordi4."', '".$ordi5."', '".$ordinaconnectat."', '".$ni1."', '".$ni2."', '".$ni3."', '".$ni4."', '".$ni5."', '".$ni6."', '".$turno."', '".$asignatura."', '".$chor."', '".$cmin."')";
