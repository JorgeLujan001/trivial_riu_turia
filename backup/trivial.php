...
<script language="javascript">
    ...
    function consultapreg(pepe, nomasig, nivell){
    	var params = {
        	"pep": pepe,
            "assignatura": nomasig,
            "nivell": nivell
...
<div style="position: absolute; left: 620px; top: 0px; width: 360px;"><div class="menu03" ><table style="text-align: left;  width: 100%;" border="0" cellpadding="1" cellspacing="1">
    <tbody>
    <tr>
...
<span style="font-family: Verdana; font-style: normal; font-variant: normal; font-weigh<: normal; font-size: 12px; line-height: normal; font-size-adjust: none; font-stretch: normal;">
...
<div id="menuassignatures" class="menu02" ><form action="t" name="assig"><span style="font-family: Verdana; font-style: normal; font-variant: normal; font-weight: normal; font-size: 12px; line-height: normal; font-size-adjust: none; font-stretch: normal;"><table style="text-align: left;  width: 100%;" border="1" cellpadding="2" cellspacing="2">
    <tbody>
    <tr>
    <td style=" background-color:#da1b0b"></td><td><input checked="checked" name="assig11" value="1" type="checkbox" >English</td><td><input  name="assig12" value="2" type="checkbox">Grec</td><td><input  name="assig13" value="3" type="checkbox">Llat&iacute;</td><td colspan="2"><input  name="assig14" value="4" type="checkbox">Fran&ccedil;ais</td>
</tr>
<tr><td style=" background-color:#1d950f"></td><td><input checked="checked" name="assig21" value="1" type="checkbox">Biologia</td><td><input checked="checked" name="assig22" value="2" type="checkbox">Mates</td><td><input checked="checked" name="assig23" value="3" type="checkbox">F. i Q.</td><td><input  name="assig24" value="4" type="checkbox">Tecnologia</td><td><input  name="assig25" value="5" type="checkbox">Info</td>
</tr>
<tr><td style=" background-color:#ad6038"></td><td><input checked="checked" name="assig31" value="1" type="checkbox">Educ. F.</td><td><input checked="checked" name="assig32" value="2" type="checkbox">Plast.</td><td><input checked="checked" name="assig33" value="2" type="checkbox">Mus.</td><td><input name="assig34" value="3" type="checkbox">Anat. Aplic.</td><td><input  name="assig35" value="4" type="checkbox">D. Tec.</td>
</tr>
<tr><td style=" background-color:#1792dd"></td><td><input checked="checked" name="assig41" value="1" type="checkbox">Val.</td><td><input checked="checked" name="assig42" value="2" type="checkbox">Cast.</td><td colspan="3"><input  name="assig43" value="3" type="checkbox" >Literatura Universal</td>
</tr>
<tr><td style=" background-color:#e3701b"></td><td colspan="3"><input checked="checked" name="assig51" value="1" type="checkbox">Geografia i Hist&ograve;ria</td><td colspan="2"><input name="assig52" value="2" type="checkbox">Cult. Cl&agrave;ssica</td>
</tr>
<tr><td style=" background-color:#fee11e"></td><td ><input checked="checked" name="assig61" value="1" type="checkbox">Tutoria</td><td colspan="2"><input name="assig62" value="2" type="checkbox">Filosofia</td><td ><input name="assig63" value="3" type="checkbox">Religions</td><td ><input name="assig64" value="4" type="checkbox">Valors</td>
</tr>
</tbody>
...
<div class="resppreg" id="divpreguntar" style="position: absolute; left: 620px; top: 592px;"><b><form action="t" name="respostf"><span style="font-family: Verdana; font-style: normal; font-variant: normal; font-weight: normal; font-size: 13px; line-height: normal; font-size-adjust: none; font-stretch: normal;">Resposta:&nbsp;</span><input name="respuesta" onkeydown="return event.key != 'Enter';">
&nbsp;<input name="comprova" onclick="respostes()" value="Comprova" type="button"></form></b></div>
</span>
<div class="presentaci" id="presentacio" style="position: absolute; left: 595px; top: 0px;"><div style="position: absolute; left: 0px; top: 50px;"><img style="width: 420px; height: 280px;" alt="" name="present" src="presen/b841.png"></div><div style="position: absolute; left: 0px; top: 0px;"><img style="width: 420px; height: 65px;" alt="" src="presen/cortina2.png"></div></div>
...
<div id="botonguardar" style="position: absolute; left: 480px; top: 20px;"><form action="t" name="botonguardar"><input onclick="document.getElementById('confirmaguardar').style.visibility='visible'" value="Guardar partida" type="button"></form></div>


<div id="confirmaguardar" class="menu05" style="position: absolute; left: 300px; top: 200px;"><form action="t" name="confirmaguardar"><center><span style="font-family: Verdana; font-style: normal; font-variant: normal; font-weight: bold; font-size: 20px; line-height: normal; font-size-adjust: none; font-stretch: normal;">Estàs segur/a que vols guardar la partida?<br><br>
<input onclick="guardarpartida()" value="   Sí   " type="button">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input onclick="document.getElementById('confirmaguardar').style.visibility='hidden'" value="   No   " type="button"></span></center></form></div>
