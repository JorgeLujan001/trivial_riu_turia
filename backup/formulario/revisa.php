...
if(preguntas[numero][1]=="etica"){pipi="Valors &Eacute;tics";document.getElementById('divpregunta').style.backgroundColor ='#fee11e';};
    ...
    document.getElementById("divpreguntat").innerHTML=preguntas[numero][3];
...
<div class="section"><span>8</span><small>Fes clic en la següent casella si vols que la resposta NO es mostre quan es falla la pregunta:</small><input type="checkbox" name="no_mostrar2" id="no_mostrar2" value="1" onkeydown="return event.key != 'Enter';"></div>
<br><br>
...
<div class="section"><span>8</span>Data:</div>
<input type="datetime-local" name="data" onkeydown="return event.key != 'Enter';"><br><br>
<div class="section"><span>9</span>Verificada:</div>
