...
if ($uploadOk == 0) {
  ...
  $consulta="UPDATE preguntas SET assignatura='".$assignaturaval2."', nivell ='".$nivellval2."', text ='".$textval2."', no_mostrar ='".$no_mostrarval2."', respostes ='".$respostesval2."', intents ='".$intentsval2."', temps ='".$tempsval2."', grafica ='".$graficaval2."', verificada ='".$verificadaval2."' WHERE codi_pregunta='".$idval2."'";
...
// if everything is ok, try to upload file
  ...
  if (move_uploaded_file($_FILES["imatge2"]["tmp_name"], $target_file)) {
    ...
    $consulta="UPDATE preguntas SET assignatura='".$assignaturaval2."', nivell ='".$nivellval2."', text ='".$textval2."', no_mostrar ='".$no_mostrarval2."', respostes ='".$respostesval2."', intents ='".$intentsval2."', temps ='".$tempsval2."', imatge ='".$imatgeval2."', grafica ='".$graficaval2."', verificada ='".$verificadaval2."' WHERE codi_pregunta='".$idval2."'";
    $mysqli->query($consulta);
  } else {
